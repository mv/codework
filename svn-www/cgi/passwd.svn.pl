...
# $Id: passwd.change.pl 7 2006-09-26 19:12:28Z marcus.ferreira $
#
...
my $passwdfile="/u01/subversion/repos/mdb_ro_htpasswd";
...
if( $ok ) {
    ...
    <body>
    <hr>
    <a href="/viewsvn">Subversion: Projeto EBS/Salto </a>
    <hr>
    </body>
    OK
