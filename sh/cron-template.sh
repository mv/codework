...
SUBJECT="FTP Punch XML"

APP_DIR=/abd/app/libertadores
LOG_DIR=/abd/logs/libertadores
...
cd $APP_DIR && \
    lftp -c 'open -e "mirror -n -v ./ input/" ftp://punch:senha@ftpsites.abril.com.br/ArquivosXML/'
    1>> $LOG 2>> $LOG
