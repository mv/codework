...
syn keyword sqlKeyword	else elsif end exception exclusive fetch file for from
...
syn keyword sqlKeyword	nocompress nowait of offline on online open order over
syn keyword sqlKeyword	partition start successful synonym table then to trigger uid
...
syn keyword sqlType	boolean char character clob date float integer long
...
syn keyword sqlFunction  existsnode exp extract extractvalue exit feature_id
